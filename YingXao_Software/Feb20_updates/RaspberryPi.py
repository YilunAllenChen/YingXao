...
humidity_required = result['-MTyQRBAIG2OaoOvH127'][plantType]['humidity_s'] #standard humidity
sunlight_required = result['-MTyQRBAIG2OaoOvH127'][plantType]['sunlight_s'] #standard sunlight
...
while True:
    ...
    time.sleep(3600) #send data once an hour
